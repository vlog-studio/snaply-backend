...
| `src/_app/providers` | `app-providers.tsx` | Mounts `PushTokenGate`, `GeofenceGate`, and `MovieGenerationBridge`, alongside the three headless nodes this feature does not use ([Application shell and navigation](app-shell-and-navigation.md#composition-and-ownership)). |
