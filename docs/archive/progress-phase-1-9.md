# 진행 기록 — Phase 1~9 (초기 개발, ~2026-08-03)

> **보관 문서** (2026-09-03 이동): 초기 개발 가이드 시절 Phase 1~9의 완료 기록이다.
> **각 Phase의 표·기술명은 완료 시점의 기록이며, 이후 뒤집힌 것이 있다** — 특히 Phase 8의
> Stripe 구독은 2026-08-13~14에 전부 제거됐고(현행 결제는 크레딧+IAP), Phase 4의 월 3편
> 제한도 제거됐다. 각 절의 ❌ 배너가 뒤집힌 지점을 표시한다. 현행 사실은
> [progress.md](../progress.md)의 이후 기록과 각 원천 문서를 본다.
> 이동하면서 상대 링크 경로만 archive 위치에 맞게 고쳤다(그 외 본문 불변).
